...
<form action="${var}" method="POST">
    ...
    <div class="container alert alert-info" style="width:350px;">
        ...
        <div class="row d-flex justify-content-center" >
            <input type="text" name="name" id="name" accept-charset="UTF-8">
    ...
    <div class="container alert alert-info" style="width:350px;">
        ...
        <div class="row d-flex justify-content-center">
            <input type="text" name="age" id="age" pattern="^[0-9]+$" >
    ...
    <div class="container alert alert-info" style="width:350px;">
        ...
        <div class="row d-flex justify-content-center">
            <input type="text" name="company" id="company"  accept-charset="UTF-8">
    ...
    <div class="container alert alert-info" style="width:350px;">
        ...
        <div class="row d-flex justify-content-center">
            <input type="text" name="money" id="money" pattern="^[0-9]+$" >
